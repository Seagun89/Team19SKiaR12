...
namespace Team19SKiaR12
{
    public class RightEndCap
    {
        ...
        public void Draw(SKCanvas canvas)
        {
            ...
            path.MoveTo(trianglePt.X - this.heightTriangle, trianglePt.Y + this.heightTriangle / 2); //left
            path.LineTo(trianglePt.X - this.heightTriangle, trianglePt.Y - this.heightTriangle / 2); // draw line to the top
            path.LineTo(trianglePt.X, trianglePt.Y); // draw line to the right
            path.LineTo(trianglePt.X - this.heightTriangle, trianglePt.Y + this.heightTriangle / 2); //draw line to the left
